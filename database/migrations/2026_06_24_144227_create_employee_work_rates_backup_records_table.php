...
return new class extends Migration
{
    ...
    {
        Schema::create('employee_work_rates_backup_records', function (Blueprint $table) {
            $table->id();
            ...
            $table->double('emp_late_hours')->default(0);
            $table->double('normal_rate_otwork_hrs');
            $table->double('double_rate_otwork_hrs');
            $table->double('triple_rate_otwork_hrs')->default(0);
            $table->double('holiday_nopay_days')->default(0);
            $table->double('holiday_normal_ot_hrs')->default(0);
            $table->double('holiday_double_ot_hrs')->default(0);
    ...
    {
        Schema::dropIfExists('employee_work_rates_backup_records');
    }
};