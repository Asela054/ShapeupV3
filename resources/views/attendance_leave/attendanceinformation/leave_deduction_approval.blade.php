			...
			<div id="kt_app_toolbar_container" class="app-container">
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					...
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<li class="breadcrumb-separator"></li>
						<li class="breadcrumb-item text-gray-700">Leave Deduction Approval</li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="card">
					<div class="card-body p-0 p-2">
						...
						<div class="table-responsive">
							<table class="table align-middle table-row-dashed fs-6 gy-5" id="leave_deduction_approvalTable">
								<thead>
...
@section('scripts')
	<script>
		...
		$(document).ready(function () {
			...
			var table = $('#leave_deduction_approvalTable').DataTable({
				processing: true,
				serverSide: true,
				ajax: {
					url: "{{ route('leave_deduction_approval') }}",
					data: function (d) {
				...
				columns: [
					...
					{ data: 'total_absent_days', name: 'total_absent_days' },
			...
			$('#approve_all').on('click', function () {
				var selectedIds = [];
				$('#leave_deduction_approvalTable tbody .row-checkbox:checked').each(function () {
						...
						$.ajax({
							...
							success: function (response) {
								Swal.fire({
									icon: 'success',
									title: 'Approved!',
									text: response.message ?? 'Leave deduction records approved successfully.',
									timer: 2000,
