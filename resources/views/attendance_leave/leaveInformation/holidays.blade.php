			...
			<div id="kt_app_toolbar_container" class="app-container">
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					...
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<li class="breadcrumb-separator"></li>
						<li class="breadcrumb-item text-gray-700">Holidays</li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="card">
					<div class="card-body p-0 p-2">
						<div class="d-flex justify-content-between align-items-center mb-5 mt-5">
							...
							<div>
								<button type="button" class="btn btn-primary btn-sm px-4" name="create_record" id="create_record"><i class="fas fa-plus mr-2"></i>Add Holidays</button>
							</div>
						</div>

						<div class="table-responsive">
							<table class="table align-middle table-row-dashed fs-6 gy-5" id="holidaysTable">
								<thead>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="fw-bold" id="modalTitle">Add Holiday</h2>
...
@section('scripts')
	<script>
		...
		$(document).ready(function () {
				...
				columns: [
					...
					{ data: 'holiday_type', name: 'holiday_type' },
					{
						...
						render: function (data) {
							if (data == 1 || data == '1') return 'Full Day';
							if (data == 0.5) return 'Half Day';
							if (data == 0.25) return 'Short';
							return data;
						}
					},
					{ data: 'date', name: 'date' },
						...
						render: function (data, type, row) {
							return `
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
									<div class="menu-item">
										<a class="menu-link editHoliday" href="#" data-id="${row.id}">
											<span class="menu-icon"><i class="fa-solid fa-pen"></i></span>
											<span class="menu-title">Edit</span>
										</a>
									</div>
									<div class="menu-item">
										<a class="menu-link deleteHoliday" href="#" data-id="${row.id}">
			...
			// Edit action handler
			$(document).on('click', '.editHoliday', function (e) {
				e.preventDefault();
				...
				$.ajax({
					...
					success: function (data) {
						...
						$('#holidayForm button[type="submit"]').text('Update');
						$('#modalTitle').text('Edit Holiday');
						$('#holidayModal').modal('show');
					},
					error: function () {
						Swal.fire({ icon: 'error', title: 'Error', text: 'Failed to load holiday data' });
					}
				});
			});
			...
			$(document).on('click', '.deleteHoliday', function (e) {
				...
				Swal.fire({
					title: 'Are you sure?',
					text: "This will delete the holiday!",
					icon: 'warning',
