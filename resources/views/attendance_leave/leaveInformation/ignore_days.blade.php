...
@section('content')
			...
			<div id="kt_app_toolbar_container" class="app-container">
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					...
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<li class="breadcrumb-separator"></li>
						<li class="breadcrumb-item text-gray-700">Ignore Days</li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="card">
					<div class="card-body p-0 p-2">
						<div class="d-flex justify-content-between align-items-center mb-5 mt-5">
							...
							<div>
								<button type="button" class="btn btn-primary btn-sm px-4" name="create_record" id="create_record"><i class="fas fa-plus mr-2"></i>Add Ignore Days</button>
							</div>
						</div>

						<div class="table-responsive">
							<table class="table align-middle table-row-dashed fs-6 gy-5" id="ignoreDaysTable">
								<thead>
	...
	<!-- Add Ignore Days Modal -->
    <div class="modal fade" id="ignoreDaysModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="fw-bold" id="modalTitle">Add Ignore Days</h2>
                ...
                <div class="modal-body">
                    <form id="ignoreDaysForm" method="POST" action="">
                        @csrf
                        <div class="row g-4">
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="text" name="dates" id="dates" class="form-control" placeholder="Select Dates" autocomplete="off" disabled required />
                            </div>
                        </div>
                        <br>
	...
	<script>
		...
		$(document).ready(function () {
			...
			$('#month').on('change', function () {
				...
				datesPicker.set('minDate', firstDay);
				datesPicker.set('maxDate', lastDay);
				datesPicker.clear();

				$('#dates').prop('disabled', false);
			});

			// Multi-date picker (dates within selected month)
			var datesPicker = flatpickr("#dates", {
				mode: "multiple",
				dateFormat: "Y-m-d",
				disable: []
			});
						...
						render: function (data, type, row) {
							return `
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
									<div class="menu-item">
										<a class="menu-link deleteIgnoreDay" href="#" data-id="${row.id}">
			...
			// Delete action 
			$(document).on('click', '.deleteIgnoreDay', function (e) {
				e.preventDefault();
				const id = $(this).data('id');

				Swal.fire({
					title: 'Are you sure?',
					text: "This will delete the ignore day!",
					icon: 'warning',
						...
						$.ajax({
							...
							error: function (xhr) {
								Swal.fire({
									icon: 'error',
									title: 'Error',
									text: 'Failed to delete ignore day'
								});
							}
						});
					}
