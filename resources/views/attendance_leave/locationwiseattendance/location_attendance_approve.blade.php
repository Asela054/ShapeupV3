			...
			<div id="kt_app_toolbar_container" class="app-container">
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
						Location Attendance Approve</h1>
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						...
						<li class="breadcrumb-separator"></li>
						<li class="breadcrumb-item text-gray-700">Location Attendance Approve</li>
					</ul>
				</div>
			</div>
		</div>
				...
				<div class="card">
					<div class="card-body p-0 p-2">
						...
						<div class="table-responsive">
							<table class="table align-middle table-row-dashed fs-6 gy-5" id="locationAttendanceApproveTable">
								<thead>
...
@section('scripts')
	<script>
		...
		$(document).ready(function () {
			...
			var table = $('#locationAttendanceApproveTable').DataTable({
				processing: true,
				serverSide: true,
				ajax: {
					url: "{{ route('location_attendance_approve') }}",
					data: function (d) {
