...
@section('content')
				...
				<div class="card">
					<div class="card-body p-0 p-2">
						...
						<div class="table-responsive">
							<table class="table align-middle table-row-dashed fs-6 gy-5" id="assigned_devicesTable">
								<thead>
	...
	<div class="modal fade" id="assigned_devicesModal" tabindex="-1" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-lg">
			<div class="modal-content">
				<div class="modal-header">
					<h2 class="fw-bold" id="modalTitle">Add Device</h2>
				...
				<div class="modal-body">
					<form id="assigned_devicesForm" enctype="multipart/form-data" method="POST" action="">
						@csrf
						<div class="row g-4">
							<div class="col-md-6">
	...
	<script>
		...
		$(document).ready(function () {
						...
						render: function (data, type, row) {
							return `
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
									<div class="menu-item">
										<a class="menu-link editDevice" href="#" data-id="${row.id}">
											<span class="menu-icon"><i class="fa-solid fa-pen"></i></span>
											<span class="menu-title">Edit</span>
										</a>
									</div>
									<div class="menu-item">
										<a class="menu-link deleteDevice" href="#" data-id="${row.id}">
			...
			$(document).on('click', '.editDevice', function (e) {
				...
				$.ajax({
					url: `/employee_management/masterdata/assigned_device/${id}/edit`,
					type: 'GET',
					success: function (data) {
						...
						if ($('#assigned_devicesForm input[name="_method"]').length === 0) {
							$('#assigned_devicesForm').append('<input type="hidden" name="_method" value="PUT">');
						}

						$('#assigned_devicesForm button[type="submit"]').text('Update Device');
			...
			$(document).on('click', '.deleteDevice', function (e) {
				...
				Swal.fire({
					...
					if (result.isConfirmed) {
						$.ajax({
							url: `/employee_management/masterdata/assigned_device/${id}`,
							type: 'DELETE',
