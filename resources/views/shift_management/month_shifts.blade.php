			...
			<div id="kt_app_toolbar_container" class="app-container">
				<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
					<h1 class="page-heading d-flex text-gray-900 fw-bold fs-3 flex-column justify-content-center my-0">
						Monthly Shift Roster</h1>
					<ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
						<li class="breadcrumb-item text-muted">Shift_Management</li>
						<li class="breadcrumb-separator"></li>
						<li class="breadcrumb-item text-gray-700">Monthly Shift Roster</li>
					</ul>
				</div>
			</div>
		</div>
			...
			<div id="kt_app_content_container" class="app-container container-fluid mt-2 p-0 p-2">
				<div class="card">
					<div class="card-body p-0 p-2">
						...
						<div id="Container" class="min-h-300px">
			...
			$('#filterForm').on('submit', function (e) {
				...
				$.ajax({
					...
					success: function (response) {
						$('#rosterViewContainer').html(response);
						closeFilterPanel();
					},
					error: function () {
